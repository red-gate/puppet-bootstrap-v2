...
$WarningString = "### !!! This file is built using the build.ps1 script. Do not edit this file directly. !!! ###"
...
# Insert the warning string into the server and agent scripts at line 1 so it appears directly after the shebang.
$ServerBootstrapScriptContent = @($ServerBootstrapScriptContent[0]) + $WarningString + $ServerBootstrapScriptContent[1..($ServerBootstrapScriptContent.Length - 1)]
$AgentBootstrapScriptContent = @($AgentBootstrapScriptContent[0]) + $WarningString + $AgentBootstrapScriptContent[1..($AgentBootstrapScriptContent.Length - 1)]

$ServerBootstrapScriptContent = $ServerBootstrapScriptContent -join "`n"
$AgentBootstrapScriptContent = $AgentBootstrapScriptContent -join "`n"
